...
--batch_size 128  --dataset domain_quick --figsize 224 --loss_type ce --model resnet50 --num_workers 4 --Bob_layer 1.6 \
...
--LP_dir LP_IN1K50_domquicknew_boblayer1p6 \
--run_name FT__LP_IN1K50_domquicknew_boblayer1p6__bob99