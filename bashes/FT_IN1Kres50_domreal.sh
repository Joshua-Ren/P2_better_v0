...
--batch_size 64  --dataset domain_real --figsize 224 --loss_type ce --model resnet50 --num_workers 4 \
--lr 0.0003 --epochs 100 --min_lr 0.00001 \
--work_dir ./results/IN1K_res50_PT \
--alice_name resnet50-classification.pth \
--LP_dir LP_IN1K50_domreal_2en3wd_f224 \
--run_name FT__LP_IN1K50_domreal_2en3wd_f224__3en4b64_run1