...
--batch_size 128  --dataset domain_sketch --figsize 224 --loss_type ce --model resnet50 --num_workers 4 --Bob_depth 2 \
--lr 0.01 --warmup 5 --epochs 200 \
--work_dir ./results/IN1K_simclr_PT --proj_name betterv0_Fig7LP \
--alice_name resnet50-simclr.pth \
--run_name Tab1_simclrres50_domsketch_bobdepth2