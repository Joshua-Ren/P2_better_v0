...
--batch_size 128  --dataset domain_sketch --figsize 224 --loss_type ce --model resnet50 --num_workers 4 --Bob_layer 1 \
...
--LP_dir LP_IN1K50_domsketchnew_boblayer1 \
--run_name FT__LP_IN1K50_domsketchnew_boblayer1__bob99