...
--batch_size 128  --dataset domain_real --figsize 32 --loss_type ce --model resnet18 --num_workers 4 \
--lr 0.0002 --weight_decay 0 --min_lr 0.002 \
--work_dir ./results/C10_res18_PT \
--alice_name Alice_resnet18_PT.pth \
--run_name LP_domreal_2en4nowdnodecay