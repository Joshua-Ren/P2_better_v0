...
--batch_size 128  --dataset domain_sketch --figsize 224 --loss_type ce --model resnet50 --num_workers 4 --Bob_depth 3 \
...
--LP_dir LP_IN1K50_domsketchnew_2en3nowdnodecay_bobdpth3 \
--run_name FT__LP_IN1K50_domsketch_bobdpth3_bob1023